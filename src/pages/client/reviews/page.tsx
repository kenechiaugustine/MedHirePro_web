    ...
    if (submitted) {
        return (
            <div className="max-w-xl mx-auto my-12 bg-white border border-slate-100 shadow-md rounded-2xl p-8 text-center space-y-5">
                <div className="w-16 h-16 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600 mx-auto text-3xl">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="space-y-1.5">
                    ...
                    <textarea
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-xs outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-400 font-semibold text-slate-700 placeholder-slate-400 resize-none"
                    />
                </div>
                ...
                <button
                    ...
                    className="w-full py-3 bg-teal-600 hover:bg-teal-700 disabled:opacity-40 disabled:cursor-not-allowed text-white rounded-xl text-xs font-black shadow-md shadow-teal-600/15 flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                >
                    {isLoading ? (
