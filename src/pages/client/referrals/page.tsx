        ...
        return (
            <div className="flex h-96 items-center justify-center">
                <div className="flex flex-col items-center gap-2">
                    <FiLoader className="animate-spin h-8 w-8 text-indigo-650" />
            ...
            <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-900 rounded-2xl p-6 md:p-8 text-white shadow-lg border border-indigo-500/10">
                <div className="space-y-2">
                    ...
                    <p className="text-slate-250 text-xs md:text-sm font-medium opacity-90 leading-relaxed font-sans max-w-2xl">
                        Share your unique invite code with other medical institutions or practitioners. Earn bonus credits when they sign up and get verified!
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-slate-150 rounded-2xl shadow-md p-6 flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <span className="text-[10px] text-slate-450 font-bold block">Members verified</span>
                    </div>
                </div>
                ...
                <div className="lg:col-span-1 bg-white border border-slate-150 rounded-2xl shadow-md p-6 space-y-6">
                    <div className="pb-3 border-b border-slate-100 space-y-1">
                        <h3 className="font-extrabold text-slate-800 text-sm flex items-center gap-1.5">
                            <FiUserCheck className="text-indigo-600" /> Verify Referrer
                        </h3>
                        ...
                        <form onSubmit={handleApplyReferrer} className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-400 font-semibold text-slate-700 uppercase tracking-wide font-mono"
                                />
                            </div>
                            <button
                                type="submit"
                            ...
                            // className="w-full py-2.5 bg-indigo-650 hover:bg-indigo-700 disabled:opacity-40 text-white rounded-xl text-xs font-black shadow-md shadow-indigo-600/15 flex items-center justify-center gap-1.5 transition-all cursor-pointer"
                            >
                                        ...
                                        <tr key={item._id} className="hover:bg-slate-50/40">
                                            <td className="px-6 py-3.5">
                                                <div className="font-extrabold text-slate-800 truncate max-w-[170px]">
                                                    {item.full_name || "New Practitioner"}
                                                </div>
                                                <div className="text-[10px] text-slate-400 truncate max-w-[170px] font-semibold">
                                                    {item.email}
                                                </div>
                                            </td>
                                            <td className="px-6 py-3.5 font-semibold text-slate-550 truncate max-w-[110px]">
                                            ...
                                            <td className="px-6 py-3.5 text-right whitespace-nowrap">
                                                <span className={`px-2 py-0.5 rounded text-[9px] font-black uppercase tracking-wider ${item.is_active
